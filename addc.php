    ...
    <div id="header_top">
      ...
      <div id="main-menu">
          <ul class="menu" id="main_nav">
            ...
            <li class="menu-item current-menu-item"><a href="about.html" title="home">About us</a></li>
...
function test3(){document.getElementById("extra").innerHTML="<form action='insert_data.php' id='myform2' method='post'> Lab speciality: &nbsp;<select name='ltype'><option value='b'>Scan and Analysis</option><option value='s'>Scan</option><option value='a'>Analysis</option></select> \
<br><br>Working hours: &nbsp;<input type='text' name='working_Hours'></form>";}


function test4(){
document.getElementById("extra").innerHTML="<form action='insert_data.php' id='myform2' method='post'>Working hours: &nbsp;<input type='text' name='working_Hours'> \
<br><br>Delivery: &nbsp;<input type='radio' name='delivery' value='y'>Available &nbsp; &nbsp;<input type='radio' name='delivery' value='n'>Not available</form>";}
  ...
  <div class="clear"></div>
      ...
      <div class="box box-orange fixed">
        ...
        <!--  <form action="addnew.php" method="post">
          ...
          <form action='insert_data.php' id='form' method='post'> 
          <input type="hidden" name='fac_type' value='c' >
...
<br><br>Spetiality: &nbsp;<select name='ctype'><option value='Dent'>Dental</option><option value='Derm'>Dermatology</option><option value='Card'>Cardiology</option></select> 
<br><br>fees: &nbsp;<input type='text' name='fees' autocomplete="off"> 
