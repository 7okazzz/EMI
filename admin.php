    ...
    <div id="header_top">
      ...
      <div id="main-menu">
          <ul class="menu" id="main_nav">
            ...
            <li class="menu-item"><a href="contacts.php" title="home">Contacts</a></li>
          </ul>
        </div>
    </div>
...
$result1 = mysql_query('SELECT count(*)  from facilities') or die(mysql_error());
$result2 = mysql_query('select count(*) from medical_labs') or die(mysql_error());
$result3 = mysql_query('select count(*) from clinics') or die(mysql_error());
$result4 = mysql_query('select count(*) from pharmacies') or die(mysql_error());
$row1 = mysql_fetch_assoc($result1);
$row2 = mysql_fetch_assoc($result2);
$row3 = mysql_fetch_assoc($result3);
$row4 = mysql_fetch_assoc($result4);
echo"Number Of Registred Hospitals:". $row1['count(*)'];
echo"<br><br>Number Of Registred Clinics:".$row2['count(*)'];
echo"<br><br>Number Of Registred Medical Labs:".$row3['count(*)'];
echo"<br><br>Number Of Registred Pharmacies:".$row4['count(*)'];
}
mysql_close($con);
