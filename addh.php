        ...
        <div id="menu"> 
          ...
          <ul id="topnav2">
           <li class="dropdown"><a href="#" title="Category name">Add New Facility</a>
              <ul class="children">
                <li><a href="addh.html" title="Category name">Hospital</a> </li>
  ...
  <div class="clear"></div>
      ...
      <div class="box box-orange fixed">
        ...
        <!--  <form action="addnew.php" method="post">
          ...
          <input type="hidden" name='fac_type' value='h' autocomplete="off">
...
<br><br>Departments: &nbsp;<input type='checkbox' name='dep[]' value='surgery'> surgery &nbsp; <input type='checkbox' name='dep[]' id='form' value='Infants'> Infants &nbsp; <input type='checkbox' name='dep[]' value='Radiology'> Radiology  
