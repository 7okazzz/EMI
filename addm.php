    ...
    <div id="header_top">
      ...
      <div id="main-menu">
          <ul class="menu" id="main_nav">
            ...
            <li class="menu-item"><a href="addh.php" title="home">Contacts</a></li>
          </ul>
        </div>
    </div>
  ...
  <div class="clear"></div>
      ...
      <div class="box box-orange fixed">
        ...
        <!--  <form action="addnew.php" method="post">
          ...
          <input type="hidden" name='fac_type' value='m' > 
...
<br><br>Lab speciality: &nbsp;<select name='mtype'><option value='b'>Scan and Analysis</option><option value='s'>Scan</option><option value='a'>Analysis</option></select>
